...
d.clampedTo = d.clamp = function(e, i) {
  ...
  if (e = new t(e), i = new t(i), !e.s || !i.s) return new t(NaN);
...
d.inverseTangent = d.atan = function() {
  ...
  for (m = !1, i = Math.ceil(u / w), r = 1, c = f.times(f), o = new l(f), t = f; e !== -1; )
    if (t = t.times(c), s = o.minus(t.div(r += 2)), t = t.times(c), o = s.plus(t.div(r += 2)), o.d[i] !== void 0) for (e = i; o.d[e] === s.d[e] && e--; ) ;
...
d.minus = d.sub = function(e) {
  ...
  if (n = L(e.e / w), l = L(g.e / w), f = f.slice(), s = l - n, s) {
    for (a = s < 0, a ? (i = f, s = -s, o = h.length) : (i = h, n = l, o = f.length), r = Math.max(Math.ceil(u / w), o) + 2, s > r && (s = r, i.length = 1), i.reverse(), r = s; r--; ) i.push(0);
    i.reverse();
  } else {
...
d.plus = d.add = function(e) {
  ...
  if (s = L(a.e / w), r = L(e.e / w), f = f.slice(), t = s - r, t) {
    for (t < 0 ? (n = f, t = -t, o = l.length) : (n = l, r = s, o = f.length), s = Math.ceil(u / w), o = s > o ? s + 1 : o + 1, t > o && (t = o, n.length = 1), n.reverse(); t--; ) n.push(0);
    n.reverse();
  }
...
d.times = d.mul = function(e) {
  ...
  for (n = L(l.e / w) + L(e.e / w), c = h.length, f = g.length, c < f && (s = h, h = g, g = s, o = c, c = f, f = o), s = [], o = c + f, r = o; r--; ) s.push(0);
  for (r = f; --r >= 0; ) {
    for (i = 0, t = c + r; t > r; )
...
d.toPower = d.pow = function(e) {
  ...
  if (!u.d || !e.d || !u.d[0] || !e.d[0]) return new c(q(+u, f));
  ...
  return function(r, t, s, o, u, c) {
    ...
    if (M[a] > (A[a] || 0) && l--, s == null ? (b = s = j.precision, o = j.rounding) : u ? b = s + (r.e - t.e) + 1 : b = s, b < 0)
      ...
      if (b = b / g + 2 | 0, a = 0, T == 1) {
        ...
        for (h = c / (M[0] + 1) | 0, h > 1 && (M = e(M, h, c), A = e(A, h, c), T = M.length, X = A.length), Q = T, E = A.slice(0, T), P = E.length; P < T; ) E[P++] = 0;
...
function p(e, i, n, r) {
  ...
  e: if (i != null) {
    ...
    if (r = r || i < 0 || a[h + 1] !== void 0 || (o < 0 ? l : l % q(10, t - o - 1)), f = n < 4 ? (c || r) && (n == 0 || n == (e.s < 0 ? 3 : 2)) : c > 5 || c == 5 && (n == 4 || r || n == 6 && // Check whether the digit to the left of the rounding digit is odd.
    (s > 0 ? o > 0 ? l / q(10, t - o) : 0 : a[h - 1]) % 10 & 1 || n == (e.s < 0 ? 8 : 7)), i < 1 || !a[0])
...
function ae(e, i) {
  ...
  if (i = i.slice(r, t), i) {
    if (t -= r, e.e = n = n - r - 1, e.d = [], r = (n + 1) % w, n < 0 && (r += w), r < t) {
      for (r && e.d.push(+i.slice(0, r)), t -= w; r < t; ) e.d.push(+i.slice(r, r += w));
...
function Te(e, i) {
  ...
  if (i.indexOf("_") > -1) {
    if (i = i.replace(/(\d)_(?=\d)/g, "$1"), Ee.test(i)) return ae(e, i);
  ...
  if (Le.test(i))
    ...
    throw Error(V + i);
  for (s = i.search(/p/i), s > 0 ? (c = +i.slice(s + 1), i = i.substring(2, s)) : i = i.slice(2), s = i.indexOf("."), o = s >= 0, r = e.constructor, o && (i = i.replace(".", ""), u = i.length, s = u - s, t = Me(r, new r(n), s, s * 2)), f = z(i, n, R), l = f.length - 1, s = l; f[s] === 0; --s) f.pop();
...
function he(e, i, n, r) {
  ...
  if (v ? (O(n, 1, $), r === void 0 ? r = g.rounding : O(r, 0, 8)) : (n = g.precision, r = g.rounding), !e.isFinite())
    ...
    for (l = Z(e), o = l.indexOf("."), v ? (t = 2, i == 16 ? n = n * 4 - 3 : i == 8 && (n = n * 3 - 2)) : t = i, o >= 0 && (l = l.replace(".", ""), h = new g(1), h.e = l.length - o, h.d = z(Z(h), 10, t), h.e = h.d.length), a = z(l, 10, t), s = c = a.length; a[--c] == 0; ) a.pop();
    if (!a[0])
      l = v ? "0p+0" : "0";
    else {
      ...
      for (o = 0, l = ""; o < c; o++) l += ue.charAt(a[o]);
      if (v) {
        if (c > 1)
          if (i == 16 || i == 8) {
            for (o = i == 16 ? 4 : 3, --c; c % o; c++) l += "0";
            for (a = z(l, t, i), c = a.length; !a[c - 1]; --c) ;
            for (o = 1, l = "1."; o < c; o++) l += ue.charAt(a[o]);
          } else
...
function Ke(e) {
  ...
  for (i = 0; i < s.length; i += 3)
    if (n = s[i], t && (this[n] = fe[n]), (r = e[n]) !== void 0)
      if (L(r) === r && r >= s[i + 1] && r <= s[i + 2]) this[n] = r;
...
function ci(e) {
  ...
  for (r = u[--s], e %= w, r && e && (t = q(10, w - e), u[s] = (r / t | 0) * t); u[s] === 0; s--) u.pop();
  if (s < 0)
    n = 0, u = [0];
  else {
